...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : mar. 05 mai 2026 à 09:51
...
--
-- Base de données : `gsb_projet_achachi`
--
...
CREATE TABLE IF NOT EXISTS `avoir` (
  ...
  PRIMARY KEY (`VIS_MATRICULE`,`RAP_NUM`,`MO_Code`),
  KEY `avoir_motif_FK` (`MO_Code`)
...
('b13', 'Bentot', 'Pascal', '11 av 6 Juin', '67000', 'STRASBOURG', '1996-03-11 00:00:00', 1, 'N', 'GE'),
...
('c14', 'Daburon', 'François', '13 r Champs Elysées', '6000', 'NICE', '1989-02-01 00:00:00', 1, 'P', 'PA'),
...
--
-- Structure de la table `etre_responsable`
--

DROP TABLE IF EXISTS `etre_responsable`;
CREATE TABLE IF NOT EXISTS `etre_responsable` (
  `COL_MATRICULE` varchar(10) NOT NULL,
  `SEC_CODE` varchar(1) NOT NULL,
  `REG_CODE` varchar(2) NOT NULL,
  PRIMARY KEY (`COL_MATRICULE`,`SEC_CODE`,`REG_CODE`),
  KEY `etre_resp_sec_FK` (`SEC_CODE`),
  KEY `etre_resp_reg_FK` (`REG_CODE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE IF NOT EXISTS `interagir` (
  ...
  KEY `interagir_medB_FK` (`MED_Perturbe`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
(3, 'Remontée suite à chute de prescription'),
(4, 'Demande du praticien'),
(5, 'Autre (à préciser)');
...
CREATE TABLE IF NOT EXISTS `offrir` (
  ...
  KEY `offrir_medicament_FK` (`MED_DEPOTLEGAL`),
...
INSERT INTO `offrir` (`VIS_MATRICULE`, `COL_MATRICULE`, `RAP_NUM`, `MED_DEPOTLEGAL`, `OFF_QTE`) VALUES
('b13', NULL, 5, 'DORNOM8', 8),
('b13', NULL, 6, 'APATOUX22', 10),
('b13', NULL, 7, 'APATOUX22', 8),
('b13', NULL, 8, 'DOLRIL7', 6);
...
CREATE TABLE IF NOT EXISTS `praticien` (
  ...
  `PRA_COEFF_CONFIANCE` float DEFAULT NULL,
  PRIMARY KEY (`PRA_NUM`),
...
INSERT INTO `praticien` (`PRA_NUM`, `PRA_PRENOM`, `PRA_NOM`, `PRA_ADRESSE`, `PRA_CP`, `PRA_VILLE`, `PRA_COEFNOTORIETE`, `TYP_CODE`, `PRA_COEFF_CONFIANCE`) VALUES
(1, 'Alain', 'Notini', '114 r Authie', '85000', 'LA ROCHE SUR YON', 290.03, 'MH', NULL),
(2, 'Albert', 'Gosselin', '13 r Devon', '41000', 'BLOIS', 307.49, 'MV', NULL),
(3, 'André', 'Delahaye', '36 av 6 Juin', '25000', 'BESANCON', 185.79, 'PS', NULL),
(4, 'André', 'Leroux', '47 av Robert Schuman', '60000', 'BEAUVAIS', 172.04, 'PH', NULL),
(5, 'Anne', 'Desmoulins', '31 r St Jean', '30000', 'NIMES', 94.75, 'PO', NULL),
(6, 'Anne', 'Mouel', '27 r Auvergne', '80000', 'AMIENS', 45.2, 'MH', NULL),
(7, 'Antoine', 'Desgranges-Lentz', '1 r Albert de Mun', '29000', 'MORLAIX', 20.07, 'MV', NULL),
(8, 'Arnaud', 'Marcouiller', '31 r St Jean', '68000', 'MULHOUSE', 396.52, 'PS', NULL),
(9, 'Benoit', 'Dupuy', '9 r Demolombe', '34000', 'MONTPELLIER', 395.66, 'PH', NULL),
(10, 'Bernard', 'Lerat', '31 r St Jean', '59000', 'LILLE', 257.79, 'PO', NULL),
(11, 'Bertrand', 'Marçais-Lefebvre', '86Bis r Basse', '67000', 'STRASBOURG', 450.96, 'MH', NULL),
(12, 'Bruno', 'Boscher', '94 r Falaise', '10000', 'TROYES', 356.14, 'MV', NULL),
(13, 'Catherine', 'Morel', '21 r Chateaubriand', '75000', 'PARIS', 379.57, 'PS', NULL),
(14, 'Chantal', 'Guivarch', '4 av Gén Laperrine', '45000', 'ORLEANS', 114.56, 'PH', NULL),
(15, 'Christophe', 'Bessin-Grosdoit', '92 r Falaise', '6000', 'NICE', 60, 'PO', 81),
(16, 'Claire', 'Rossa', '14 av Thiès', '6000', 'NICE', 529.78, 'MH', NULL),
(17, 'Denis', 'Cauchy', '5 av Ste Thérèse', '11000', 'NARBONNE', 458.82, 'MV', NULL),
(18, 'Dominique', 'Gaffé', '9 av 1ère Armée Française', '35000', 'RENNES', 213.4, 'PS', NULL),
(19, 'Dominique', 'Guenon', '98 bd Mar Lyautey', '44000', 'NANTES', 175.89, 'PH', NULL),
(20, 'Dominique', 'Prévot', '29 r Lucien Nelle', '87000', 'LIMOGES', 151.36, 'PO', NULL),
(21, 'Eliane', 'Houchard', '9 r Demolombe', '49100', 'ANGERS', 436.96, 'MH', NULL),
(22, 'Elisabeth', 'Desmons', '51 r Bernières', '29000', 'QUIMPER', 281.17, 'MV', NULL),
(23, 'Elisabeth', 'Flament', '11 r Pasteur', '35000', 'RENNES', 315.6, 'PS', NULL),
(24, 'Emmanuel', 'Goussard', '9 r Demolombe', '41000', 'BLOIS', 40.72, 'PH', NULL),
(25, 'Eric', 'Desprez', '9 r Vaucelles', '33000', 'BORDEAUX', 406.85, 'PO', NULL),
(26, 'Evelyne', 'Coste', '29 r Lucien Nelle', '19000', 'TULLE', 441.87, 'MH', NULL),
(27, 'Frédéric', 'Lefebvre', '2 pl Wurzburg', '55000', 'VERDUN', 573.63, 'MV', NULL),
(28, 'Frédéric', 'Lemée', '29 av 6 Juin', '56000', 'VANNES', 326.4, 'PS', NULL),
(29, 'Frédéric', 'Martin', 'Bât A 90 r Bayeux', '70000', 'VESOUL', 506.06, 'PH', NULL),
(30, 'Frédérique', 'Marie', '172 r Caponière', '70000', 'VESOUL', 313.31, 'PO', NULL),
(31, 'Geneviève', 'Rosenstech', '27 r Auvergne', '75000', 'PARIS', 366.82, 'MH', NULL),
(32, 'Ghislaine', 'Pontavice', '8 r Gaillon', '86000', 'POITIERS', 265.58, 'MV', NULL),
(33, 'Guillaume', 'Leveneur-Mosquet', '47 av Robert Schuman', '64000', 'PAU', 184.97, 'PS', NULL),
(34, 'Guy', 'Blanchais', '30 r Authie', '8000', 'SEDAN', 502.48, 'PH', NULL),
(35, 'Hugues', 'Leveneur', '7 pl St Gilles', '62000', 'ARRAS', 7.39, 'PO', NULL),
(36, 'Isabelle', 'Mosquet', '22 r Jules Verne', '76000', 'ROUEN', 77.1, 'MH', NULL),
(37, 'Jean-Christophe', 'Giraudon', '1 r Albert de Mun', '38100', 'VIENNE', 92.62, 'MV', NULL),
(38, 'Jean-Claude', 'Marie', '26 r Hérouville', '69000', 'LYON', 120.1, 'PS', NULL),
(39, 'Jean-François', 'Maury', '5 r Pierre Girard', '71000', 'CHALON SUR SAONE', 13.73, 'PH', NULL),
(40, 'Jean-Louis', 'Dennel', '7 pl St Gilles', '28000', 'CHARTRES', 550.69, 'PO', NULL),
(41, 'Jean-Pierre', 'Ain', '4 résid Olympia', '2000', 'LAON', 5.59, 'MH', NULL),
(42, 'Jean-Pierre', 'Chemery', '51 pl Ancienne Boucherie', '14000', 'CAEN', 396.58, 'MV', NULL),
(43, 'Jean-Pierre', 'Comoz', '35 r Auguste Lechesne', '18000', 'BOURGES', 340.35, 'PS', NULL),
(44, 'Jean-Pierre', 'Desfaudais', '7 pl St Gilles', '29000', 'BREST', 71.76, 'PH', NULL),
(45, 'JérÃ´me', 'Phan', '9 r Clos Caillet', '79000', 'NIORT', 451.61, 'PO', NULL),
(46, 'Line', 'Riou', '43 bd Gén Vanier', '77000', 'MARNE LA VALLEE', 193.25, 'MH', NULL),
(47, 'Louis', 'Chubilleau', '46 r Eglise', '17000', 'SAINTES', 202.07, 'MV', NULL),
(48, 'Lucette', 'Lebrun', '178 r Auge', '54000', 'NANCY', 410.41, 'PS', NULL),
(49, 'Marc', 'Goessens', '6 av 6 Juin', '39000', 'DOLE', 548.57, 'PH', NULL),
(50, 'Marc', 'Laforge', '5 résid Prairie', '50000', 'SAINT LO', 265.05, 'PO', NULL),
(51, 'Marc', 'Millereau', '36 av 6 Juin', '72000', 'LA FERTE BERNARD', 430.42, 'MH', NULL),
(52, 'Marie-Christine', 'Dauverne', '69 av Charlemagne', '21000', 'DIJON', 281.05, 'MV', NULL),
(53, 'Myriam', 'Vittorio', '3 pl Champlain', '94000', 'BOISSY SAINT LEGER', 356.23, 'PS', NULL),
(54, 'Nhieu', 'Lapasset', '31 av 6 Juin', '52000', 'CHAUMONT', 107, 'PH', NULL),
(55, 'Nicole', 'Plantet-Besnier', '10 av 1ère Armée Française', '86000', 'CHATELLEREAULT', 369.94, 'PO', NULL),
(56, 'Pascal', 'Chubilleau', '3 r Hastings', '15000', 'AURRILLAC', 290.75, 'MH', NULL),
(57, 'Pascal', 'Robert', '31 r St Jean', '93000', 'BOBIGNY', 162.41, 'MV', NULL),
(58, 'Pascale', 'Jean', '114 r Authie', '49100', 'SAUMUR', 375.52, 'PS', NULL),
(59, 'Patrice', 'Chanteloube', '14 av Thiès', '13000', 'MARSEILLE', 478.01, 'PH', NULL),
(60, 'Patrice', 'Lecuirot', 'résid St Pères 55 r Pigacière', '54000', 'NANCY', 239.66, 'PO', NULL),
(61, 'Patrick', 'Gandon', '47 av Robert Schuman', '37000', 'TOURS', 599.06, 'MH', NULL),
(62, 'Patrick', 'Mirouf', '22 r Puits Picard', '74000', 'ANNECY', 458.42, 'MV', NULL),
(63, 'Philippe', 'Boireaux', '15 av Thiès', '10000', 'CHALON EN CHAMPAGNE', 454.48, 'PS', NULL),
(64, 'Philippe', 'Cendrier', '7 pl St Gilles', '12000', 'RODEZ', 164.16, 'PH', NULL),
(65, 'Philippe', 'Duhamel', '114 r Authie', '34000', 'MONTPELLIER', 98.62, 'PO', NULL),
(66, 'Philippe', 'Grigy', '15 r Mélingue', '44000', 'CLISSON', 285.1, 'MH', NULL),
(67, 'Philippe', 'Linard', '1 r Albert de Mun', '81000', 'ALBI', 486.3, 'MV', NULL),
(68, 'Philippe', 'Lozier', '8 r Gaillon', '31000', 'TOULOUSE', 48.4, 'PS', NULL),
(69, 'Pierre', 'Dechâtre', '63 av Thiès', '23000', 'MONTLUCON', 253.75, 'PH', NULL),
(70, 'Pierre', 'Goessens', '22 r Jean Romain', '40000', 'MONT DE MARSAN', 426.19, 'PO', NULL),
(71, 'Pierre', 'Leménager', '39 av 6 Juin', '57000', 'METZ', 118.7, 'MH', NULL),
(72, 'Pierre', 'Née', '39 av 6 Juin', '82000', 'MONTAUBAN', 72.54, 'MV', NULL),
(73, 'Pierre-Laurent', 'Guyot', '43 bd Gén Vanier', '48000', 'MENDE', 352.31, 'PS', NULL),
(74, 'Roger', 'Chauchard', '9 r Vaucelles', '13000', 'MARSEILLE', 552.19, 'PH', NULL),
(75, 'Roland', 'Mabire', '11 r Boutiques', '67000', 'STRASBOURG', 422.39, 'PO', NULL),
(76, 'Soazig', 'Leroy', '45 r Boutiques', '61000', 'ALENCON', 570.67, 'MH', NULL),
(77, 'Stéphane', 'Guyot', '26 r Hérouville', '46000', 'FIGEAC', 28.85, 'MV', NULL),
(78, 'Sylvain', 'Delposen', '39 av 6 Juin', '27000', 'DREUX', 292.01, 'PS', NULL),
(79, 'Sylvie', 'Rault', '15 bd Richemond', '2000', 'SOISSON', 526.6, 'PH', NULL),
(80, 'Sylvie', 'Renouf', '98 bd Mar Lyautey', '88000', 'EPINAL', 425.24, 'PO', NULL),
(81, 'Thierry', 'Alliet-Grach', '14 av Thiès', '7000', 'PRIVAS', 451.31, 'MH', NULL),
(82, 'Thierry', 'Bayard', '92 r Falaise', '42000', 'SAINT ETIENNE', 271.71, 'MV', NULL),
(83, 'Thierry', 'Gauchet', '7 r Desmoueux', '38100', 'GRENOBLE', 406.1, 'PS', NULL),
(84, 'Tristan', 'Bobichon', '219 r Caponière', '9000', 'FOIX', 218.36, 'PH', NULL),
(85, 'Véronique', 'Duchemin-Laniel', '130 r St Jean', '33000', 'LIBOURNE', 265.61, 'PO', NULL),
(86, 'Younès', 'Laurent', '34 r Demolombe', '53000', 'MAYENNE', 496.1, 'MH', NULL),
(87, 'Solayman', 'Achachi', '16 av Thiès', '45000', 'Orleans', 100, 'MV', NULL);
...
CREATE TABLE IF NOT EXISTS `prescrire` (
  ...
  KEY `prescrire_tin_FK` (`TIN_Code`),
  KEY `prescrire_dos_FK` (`DOS_Code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE IF NOT EXISTS `presenter` (
  ...
  `MED_DEPOTLEGAL` varchar(10) NOT NULL,
  PRIMARY KEY (`VIS_MATRICULE`,`RAP_NUM`,`MED_DEPOTLEGAL`),
  KEY `presenter_medicament_FK` (`MED_DEPOTLEGAL`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
INSERT INTO `presenter` (`VIS_MATRICULE`, `RAP_NUM`, `MED_DEPOTLEGAL`) VALUES
('b13', 6, 'ADIMOL9'),
('b13', 5, 'LIDOXY23');
...
CREATE TABLE IF NOT EXISTS `rapport_visite` (
  ...
  `RAP_AUTRE` varchar(50) DEFAULT NULL,
  ...
  `mo_num` int(11) DEFAULT NULL,
  PRIMARY KEY (`VIS_MATRICULE`,`RAP_NUM`),
  KEY `rapport_visite_praticien2_FK` (`PRA_NUM`),
  KEY `rv_etat_FK` (`etat_code`),
  KEY `fk_rv_motif` (`mo_num`),
  KEY `fk_rv_praticien_remp` (`PRA_NUM_remplacant`),
  KEY `fk_rv_med1` (`med_depotlegal_presente1`),
  KEY `fk_rv_med2` (`med_depotlegal_presente2`),
  KEY `fk_rv_presentation` (`PRE_CODE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
INSERT INTO `rapport_visite` (`VIS_MATRICULE`, `RAP_NUM`, `RAP_DATEVISITE`, `RAP_BILAN`, `RAP_AUTRE`, `RAP_MOTIF`, `etat_code`, `PRA_NUM`, `PRA_NUM_remplacant`, `med_depotlegal_presente1`, `med_depotlegal_presente2`, `PRE_CODE`, `mo_num`) VALUES
('a131', 1, '2002-04-18', 'Médecin curieux, à recontacter en décembre pour réunion.', NULL, NULL, NULL, 23, NULL, NULL, NULL, NULL, NULL),
('a131', 2, '2003-03-23', 'RAS.\r\nChangement de tel : 05 89 89 89 89.', NULL, NULL, NULL, 41, NULL, NULL, NULL, NULL, NULL),
('a131', 3, '2021-12-03', 'Médecin énervé, ancien boxeur !', NULL, NULL, NULL, 7, NULL, NULL, NULL, NULL, NULL),
('a131', 4, '2026-05-05', 'Bilan tres bon', 'motif', '4', 1, 81, 34, 'INSXT5', 'DIMIRTAM6', NULL, 4),
('a131', 5, '2026-05-05', 'bon en general', 'motif', '3', 1, 15, 84, 'BACTIV13', 'ADIMOL9', NULL, 3),
('a131', 6, '2026-05-05', 'bon', '', '1', 3, 15, NULL, 'LIDOXY23', NULL, NULL, 1),
('a17', 1, '2003-05-21', 'Changement de direction, redéfinition de la politique médicamenteuse, recours au générique.', NULL, NULL, NULL, 4, NULL, NULL, NULL, NULL, NULL),
('b13', 1, '2025-11-12', 'ytess', NULL, 'testt', NULL, 34, NULL, NULL, NULL, NULL, NULL),
('b13', 2, '2025-11-19', 'sdgsgdsg', NULL, 'testttt', NULL, 47, NULL, NULL, NULL, NULL, NULL),
('b13', 3, '2025-11-18', 'aaaaaa', NULL, 'tttt', NULL, 59, NULL, NULL, NULL, NULL, NULL),
('b13', 4, '2025-11-18', 'aaaa', NULL, 'aaaaa', NULL, 81, NULL, NULL, NULL, NULL, NULL),
('b13', 5, '2025-11-03', 'aaaaa', NULL, 'motifffff', NULL, 15, NULL, NULL, NULL, NULL, NULL),
('b13', 6, '2025-11-17', 'trrr', NULL, 'dsdgs', NULL, 59, NULL, NULL, NULL, NULL, NULL),
('b13', 7, '2025-11-17', 'aaaaaaaaaaaaaaaaaaaaaaaaatttttttttttttttttttttttttt', NULL, 'aaaaaaaaaaaaaaaaaaaaaaaaaaaa', NULL, 34, NULL, 'AMOXIG12', 'APATOUX22', NULL, NULL),
('b13', 8, '2025-11-24', 'hjgfjfjgfjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj', NULL, 'dghshhdhgfs', NULL, 81, NULL, 'EQUILARX6', 'DOLRIL7', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `travailler` (
  ...
  PRIMARY KEY (`COL_MATRICULE`,`SEC_CODE`),
  KEY `travailler_sec_FK` (`SEC_CODE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE IF NOT EXISTS `type_individu` (
  `TIN_Code` int(11) NOT NULL,
  `TIN_Libelle` varchar(60) NOT NULL,
...
INSERT INTO `visiteur` (`VIS_MATRICULE`, `VIS_NOM`, `VIS_PRENOM`, `VIS_ADRESSE`, `VIS_CP`, `VIS_VILLE`, `VIS_DATEEMBAUCHE`, `SEC_CODE`, `REG_CODE`) VALUES
('a131', 'Villechalane', 'Louis', '8 cours Lafontaine', '29000', 'BREST', '1992-12-11 00:00:00', 'E', 'BG'),
('a17', 'Andre', 'David', '1 r Aimon de Chissée', '38100', 'GRENOBLE', '1991-08-26 00:00:00', NULL, 'RA'),
('a55', 'Bedos', 'Christian', '1 r Bénédictins', '65000', 'TARBES', '1987-07-17 00:00:00', NULL, 'OC'),
('a93', 'Tusseau', 'Louis', '22 r Renou', '86000', 'POITIERS', '1999-01-02 00:00:00', NULL, 'AQ'),
('b13', 'Bentot', 'Pascal', '11 av 6 Juin', '67000', 'STRASBOURG', '1996-03-11 00:00:00', NULL, 'GE'),
('b16', 'Bioret', 'Luc', '1 r Linne', '35000', 'RENNES', '1997-03-21 00:00:00', NULL, 'BG'),
('b19', 'Bunisset', 'Francis', '10 r Nicolas Chorier', '85000', 'LA ROCHE SUR YON', '1999-01-31 00:00:00', NULL, 'PL'),
('b25', 'Bunisset', 'Denise', '1 r Lionne', '49100', 'ANGERS', '1994-07-03 00:00:00', NULL, 'PL'),
('b28', 'Cacheux', 'Bernard', '114 r Authie', '34000', 'MONTPELLIER', '2000-08-02 00:00:00', NULL, 'OC'),
('b34', 'Cadic', 'Eric', '123 r Caponière', '41000', 'BLOIS', '1993-12-06 00:00:00', NULL, 'CE'),
('b4', 'Charoze', 'Catherine', '100 pl Géants', '33000', 'BORDEAUX', '1997-09-25 00:00:00', NULL, 'AQ'),
('b50', 'Clepkens', 'Christophe', '12 r Fédérico Garcia Lorca', '13000', 'MARSEILLE', '1998-01-18 00:00:00', NULL, 'PA'),
('b59', 'Cottin', 'Vincenne', '36 sq Capucins', '5000', 'GAP', '1995-10-21 00:00:00', NULL, 'RA'),
('c14', 'Daburon', 'François', '13 r Champs Elysées', '6000', 'NICE', '1989-02-01 00:00:00', NULL, 'PA'),
('c3', 'De', 'Philippe', '13 r Charles Peguy', '10000', 'TROYES', '1992-05-05 00:00:00', NULL, 'GE'),
('d13', 'Debelle', 'Jeanne', '134 r Stalingrad', '44000', 'NANTES', '1991-12-05 00:00:00', NULL, 'PL'),
('d51', 'Debroise', 'Michel', '2 av 6 Juin', '70000', 'VESOUL', '1997-11-18 00:00:00', NULL, 'FC'),
('e22', 'Desmarquest', 'Nathalie', '14 r Fédérico Garcia Lorca', '54000', 'NANCY', '1989-03-24 00:00:00', NULL, 'GE'),
('e24', 'Desnost', 'Pierre', '16 r Barral de Montferrat', '55000', 'VERDUN', '1993-05-17 00:00:00', NULL, 'GE'),
('e39', 'Dudouit', 'Frederic', '18 quai Xavier Jouvin', '75000', 'PARIS', '1988-04-26 00:00:00', NULL, 'IF'),
('e49', 'Duncombe', 'Claude', '19 av Alsace Lorraine', '9000', 'FOIX', '1996-02-19 00:00:00', NULL, 'OC'),
('e5', 'Enault-Pascreau', 'Celine', '25B r Stalingrad', '40000', 'MONT DE MARSAN', '1990-11-27 00:00:00', NULL, 'AQ'),
('e52', 'Eynde', 'Valerie', '3 r Henri Moissan', '76000', 'ROUEN', '1991-10-31 00:00:00', NULL, 'NO'),
('f21', 'Finck', 'Jacques', 'rte Montreuil Bellay', '74000', 'ANNECY', '1993-06-08 00:00:00', NULL, 'RA'),
('f39', 'Fremont', 'Fernande', '4 r Jean Giono', '69000', 'LYON', '1997-02-15 00:00:00', NULL, 'RA'),
('f4', 'Gest', 'Alain', '30 r Authie', '46000', 'FIGEAC', '1994-05-03 00:00:00', NULL, 'OC'),
('g19', 'Gheysen', 'Galassus', '32 bd Mar Foch', '75000', 'PARIS', '1996-01-18 00:00:00', NULL, 'IF'),
('g30', 'Girard', 'Yvon', '31 av 6 Juin', '80000', 'AMIENS', '1999-03-27 00:00:00', NULL, 'HF'),
('g53', 'Gombert', 'Luc', '32 r Emile Gueymard', '56000', 'VANNES', '1985-10-02 00:00:00', NULL, 'BG'),
('g7', 'Guindon', 'Caroline', '40 r Mar Montgomery', '87000', 'LIMOGES', '1996-01-13 00:00:00', NULL, 'AQ'),
('h13', 'Guindon', 'François', '44 r Picotière', '19000', 'TULLE', '1993-05-08 00:00:00', NULL, 'AQ'),
('h30', 'Igigabel', 'Guy', '33 gal Arlequin', '94000', 'CRETEIL', '1998-04-26 00:00:00', NULL, 'IF'),
('h35', 'Jourdren', 'Pierre', '34 av Jean Perrot', '15000', 'AURRILLAC', '1993-08-26 00:00:00', NULL, 'RA'),
('h40', 'Juttard', 'Pierre-Raoul', '34 cours Jean Jaurès', '8000', 'SEDAN', '1992-11-01 00:00:00', NULL, 'GE'),
('j45', 'Laboure-Morel', 'Saout', '38 cours Berriat', '52000', 'CHAUMONT', '1998-02-25 00:00:00', NULL, 'GE'),
('j50', 'Landre', 'Philippe', '4 av Gén Laperrine', '59000', 'LILLE', '1992-12-16 00:00:00', NULL, 'HF'),
('j8', 'Langeard', 'Hugues', '39 av Jean Perrot', '93000', 'BAGNOLET', '1998-06-18 00:00:00', NULL, 'IF'),
('k4', 'Lanne', 'Bernard', '4 r Bayeux', '30000', 'NIMES', '1996-11-21 00:00:00', NULL, 'OC'),
('k53', 'Le', 'Noel', '4 av Beauvert', '68000', 'MULHOUSE', '1983-03-23 00:00:00', NULL, 'GE'),
('l14', 'Le', 'Jean', '39 r Raspail', '53000', 'LAVAL', '1995-02-02 00:00:00', NULL, 'PL'),
('l23', 'Leclercq', 'Servane', '11 r Quinconce', '18000', 'BOURGES', '1995-06-05 00:00:00', NULL, 'AQ'),
('l46', 'Lecornu', 'Jean-Bernard', '4 bd Mar Foch', '72000', 'LA FERTE BERNARD', '1997-01-24 00:00:00', NULL, 'PL'),
('l56', 'Lecornu', 'Ludovic', '4 r Abel Servien', '25000', 'BESANCON', '1996-02-27 00:00:00', NULL, 'FC'),
('m35', 'Lejard', 'Agnès', '4 r Anthoard', '82000', 'MONTAUBAN', '1987-10-06 00:00:00', NULL, 'OC'),
('m45', 'Lesaulnier', 'Pascal', '47 r Thiers', '57000', 'METZ', '1990-10-13 00:00:00', NULL, 'GE'),
('n42', 'Letessier', 'Stephane', '5 chem Capuche', '27000', 'EVREUX', '1996-03-06 00:00:00', NULL, 'NO'),
('n58', 'Loirat', 'Didier', 'Les Pêchers cité Bourg la Croix', '45000', 'ORLEANS', '1992-08-30 00:00:00', NULL, 'CE'),
('n59', 'Maffezzoli', 'Thibaud', '5 r Chateaubriand', '2000', 'LAON', '1994-12-19 00:00:00', NULL, 'HF'),
('o26', 'Mancini', 'Anne', '5 r D\'Agier', '48000', 'MENDE', '1995-01-05 00:00:00', NULL, 'OC'),
('p32', 'Marcouiller', 'Gerard', '7 pl St Gilles', '91000', 'ISSY LES MOULINEAUX', '1992-12-24 00:00:00', NULL, 'IF'),
('p40', 'Michel', 'Jean-Claude', '5 r Gabriel Péri', '61000', 'FLERS', '1992-12-14 00:00:00', NULL, 'NO'),
('p41', 'Montecot', 'Françoise', '6 r Paul Valéry', '17000', 'SAINTES', '1998-07-27 00:00:00', NULL, 'AQ'),
('p42', 'Notini', 'Veronique', '5 r Lieut Chabal', '60000', 'BEAUVAIS', '1994-12-12 00:00:00', NULL, 'HF'),
('p49', 'Onfroy', 'Den', '5 r Sidonie Jacolin', '37000', 'TOURS', '1977-10-03 00:00:00', NULL, 'CE'),
('p6', 'Pascreau', 'Charles', '57 bd Mar Foch', '64000', 'PAU', '1997-03-30 00:00:00', NULL, 'AQ'),
('p7', 'Pernot', 'Claude-Noël', '6 r Alexandre 1 de Yougoslavie', '11000', 'NARBONNE', '1990-03-01 00:00:00', NULL, 'OC'),
('p8', 'Perrier', 'Maitre', '6 r Aubert Dubayet', '71000', 'CHALON SUR SAONE', '1991-06-23 00:00:00', NULL, 'FC'),
('q17', 'Petit', 'Jean-Louis', '7 r Ernest Renan', '50000', 'SAINT LO', '1997-09-06 00:00:00', NULL, 'NO'),
('r24', 'Piquery', 'Patrick', '9 r Vaucelles', '14000', 'CAEN', '1984-07-29 00:00:00', NULL, 'NO'),
('r58', 'Quiquandon', 'Joel', '7 r Ernest Renan', '29000', 'QUIMPER', '1990-06-30 00:00:00', NULL, 'BG'),
('s10', 'Retailleau', 'Josselin', '88Bis r Saumuroise', '39000', 'DOLE', '1995-11-14 00:00:00', NULL, 'FC'),
('s21', 'Retailleau', 'Pascal', '32 bd Ayrault', '23000', 'MONTLUCON', '1992-09-25 00:00:00', NULL, 'AQ'),
('t43', 'Souron', 'Maryse', '7B r Gay Lussac', '21000', 'DIJON', '1995-03-09 00:00:00', NULL, 'FC'),
('t47', 'Tiphagne', 'Patrick', '7B r Gay Lussac', '62000', 'ARRAS', '1997-08-29 00:00:00', NULL, 'HF'),
('t55', 'Trehet', 'Alain', '7D chem Barral', '12000', 'RODEZ', '1994-11-29 00:00:00', NULL, 'OC'),
('t60', 'Tusseau', 'Josselin', '63 r Bon Repos', '28000', 'CHARTRES', '1991-03-29 00:00:00', NULL, 'CE');
...
--
ALTER TABLE `avoir`
  ADD CONSTRAINT `avoir_motif_FK` FOREIGN KEY (`MO_Code`) REFERENCES `motif` (`MO_Code`);
...
--
-- Contraintes pour la table `etre_responsable`
--
ALTER TABLE `etre_responsable`
  ADD CONSTRAINT `etre_resp_col_FK` FOREIGN KEY (`COL_MATRICULE`) REFERENCES `collaborateur` (`COL_MATRICULE`),
  ADD CONSTRAINT `etre_resp_reg_FK` FOREIGN KEY (`REG_CODE`) REFERENCES `region` (`REG_CODE`),
  ADD CONSTRAINT `etre_resp_sec_FK` FOREIGN KEY (`SEC_CODE`) REFERENCES `secteur` (`SEC_CODE`);
...
ALTER TABLE `interagir`
  ADD CONSTRAINT `interagir_medA_FK` FOREIGN KEY (`MED_Perturbateur`) REFERENCES `medicament` (`MED_DEPOTLEGAL`),
  ADD CONSTRAINT `interagir_medB_FK` FOREIGN KEY (`MED_Perturbe`) REFERENCES `medicament` (`MED_DEPOTLEGAL`);
...
ALTER TABLE `offrir`
  ...
  ADD CONSTRAINT `fk_offrir_rapport` FOREIGN KEY (`VIS_MATRICULE`,`RAP_NUM`) REFERENCES `rapport_visite` (`VIS_MATRICULE`, `RAP_NUM`),
...
ALTER TABLE `prescrire`
  ADD CONSTRAINT `prescrire_dos_FK` FOREIGN KEY (`DOS_Code`) REFERENCES `dosage` (`DOS_Code`),
  ADD CONSTRAINT `prescrire_med_FK` FOREIGN KEY (`MED_DEPOTLEGAL`) REFERENCES `medicament` (`MED_DEPOTLEGAL`),
  ADD CONSTRAINT `prescrire_tin_FK` FOREIGN KEY (`TIN_Code`) REFERENCES `type_individu` (`TIN_Code`);

--
-- Contraintes pour la table `presenter`
--
ALTER TABLE `presenter`
  ADD CONSTRAINT `presenter_medicament_FK` FOREIGN KEY (`MED_DEPOTLEGAL`) REFERENCES `medicament` (`MED_DEPOTLEGAL`);

--
-- Contraintes pour la table `rapport_visite`
--
ALTER TABLE `rapport_visite`
  ADD CONSTRAINT `fk_rv_med1` FOREIGN KEY (`med_depotlegal_presente1`) REFERENCES `medicament` (`MED_DEPOTLEGAL`),
  ADD CONSTRAINT `fk_rv_med2` FOREIGN KEY (`med_depotlegal_presente2`) REFERENCES `medicament` (`MED_DEPOTLEGAL`),
  ADD CONSTRAINT `fk_rv_motif` FOREIGN KEY (`mo_num`) REFERENCES `motif` (`MO_Code`),
  ADD CONSTRAINT `fk_rv_praticien_remp` FOREIGN KEY (`PRA_NUM_remplacant`) REFERENCES `praticien` (`PRA_NUM`),
  ADD CONSTRAINT `fk_rv_presentation` FOREIGN KEY (`PRE_CODE`) REFERENCES `presentation` (`PRE_CODE`),
  ADD CONSTRAINT `rapport_visite_visiteur0_FK` FOREIGN KEY (`VIS_MATRICULE`) REFERENCES `visiteur` (`VIS_MATRICULE`),
  ADD CONSTRAINT `rv_etat_FK` FOREIGN KEY (`etat_code`) REFERENCES `etat` (`etat_code`),
  ADD CONSTRAINT `rv_praticien_FK` FOREIGN KEY (`PRA_NUM`) REFERENCES `praticien` (`PRA_NUM`);
...
ALTER TABLE `travailler`
  ADD CONSTRAINT `travailler_col_FK` FOREIGN KEY (`COL_MATRICULE`) REFERENCES `collaborateur` (`COL_MATRICULE`),
  ADD CONSTRAINT `travailler_sec_FK` FOREIGN KEY (`SEC_CODE`) REFERENCES `secteur` (`SEC_CODE`);
COMMIT;
